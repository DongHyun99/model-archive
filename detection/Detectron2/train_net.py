...
# dataset_source=0 posture_class, bbox, mask, key
# dataset_source=1 person_class, bbox, mask, key
# dataset_source=2 posture_class, bbox,
# dataset_source=3 posture_class(`normal', `lying'), bbox,
